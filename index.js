...
// 		const response = await fetch(`https://youtube.googleapis.com/youtube/v3/search?part=snippet&q=TheCodingTrain&key=AIzaSyDh1c6Mp55OVx3SEXECK5Mm4yR5EtPnsqE`)
...
// 	fetch(`https://www.googleapis.com/youtube/v3/channels?part=brandingSettings&id=${channelId}&key=AIzaSyDh1c6Mp55OVx3SEXECK5Mm4yR5EtPnsqE`)
// 		.then(response => response.json())
// 		.then(data => {	
// 		 let	imgURL = data["items"][0].brandingSettings.image.bannerExternalUrl
// 				//covImage.src = imgURL;
...
//add event listener to all search list items

//for(itemli of firstSearchUl)
